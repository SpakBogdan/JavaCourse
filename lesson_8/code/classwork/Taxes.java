package classwork;
/*
Напишите программу, которая запрашивает у пользователя его доход и вычисляет сумму налога -
 - согласно прогрессивной шкале налогообложения
...
public class Taxes {
    public static void main(String[] args) {
        ...
        System.out.println("Input you month income: ");
