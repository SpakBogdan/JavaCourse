...
public class Garbage {
    public static void main(String[] args) {
        ...
        switch (garbage){
            case "paper" -> System.out.println("Put it green box.");
            case "plastic" -> System.out.println("put it in yellow box.");
            case "food", "bio" -> System.out.println("Put it in brown box.");
            case "other", "rest", "metal" -> System.out.println("Pit in black box.");
            default -> System.out.println("Pls, use paper, plastic, food, bio, other, rest, metal. Save the planet!");
        }
    }
}
