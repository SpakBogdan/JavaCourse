...
public class ArraysMethods {
    ...
    // binary search
    // метод будет возвращать индекс найденого элемента или -
    // - некоторое отрицательное число, если его не нашлось
    // передаем в метод массив и числа
    // метод должен ответить на вопрос о наличии числа в масива
    ...
    // if left array[i] > right[i + 1] , swap
