...
public class Car {
    ...
    // тип трансмисии - boolean inManual = true, false
    // цена - int prise = 100 000
    // год выпуска - int age = 2015, 2016 ...
    // пробег - int km = ...


    // fields - поля - это характеристики объекта, которые есть в классе
    ...
    // совокупность этих полей описывает (задает, формурирует) объект
    ...
    // сеттеры - это методы, которые позволяет установить значения полей (set = установыть)
